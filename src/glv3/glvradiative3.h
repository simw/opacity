//
// C++ Interface: glvradiative
//
// Description: An object to fit into 'Driver' to calculate radiation according to GLV.
//
// Author: Simon Wicks <simonw@phys.columbia.edu>
//
#ifndef GLVRADIATIVE3_H
#define GLVRADIATIVE3_H
...
/**
  @author Simon Wicks <simonw@phys.columbia.edu>
  Radiative energy loss from Gyulassy-Levai-Vitev, to multiple orders in opacity
  This object fits into the interface of 'Driver'.
  It calculates the result for GLV multiple orders in opacity, with the restrictions:
  1) fixed temperature medium
  2) uncorrelated scattering, with exponential decay distribution between them
...
private:
  ...
  static const long n = numOfRandoms/2;
...
template<typename TqperpGenerate, typename TqperpCalculate, std::size_t numOfRandoms>
GlvRadiative3<TqperpGenerate, TqperpCalculate, numOfRandoms>::GlvRadiative3()
  : _x( 0. ), _k( 0. )
{
...
template<typename TqperpGenerate, typename TqperpCalculate, std::size_t numOfRandoms>
void GlvRadiative3<TqperpGenerate, TqperpCalculate, numOfRandoms>::SetParameters( Parameters& inParams )
{
...
template<typename TqperpGenerate, typename TqperpCalculate, std::size_t numOfRandoms>
void GlvRadiative3<TqperpGenerate, TqperpCalculate, numOfRandoms>::SetCoord( long dimension, double value)
{
  // Dimension 1 = k
  // Dimension 2 = x
...
template<typename TqperpGenerate, typename TqperpCalculate, std::size_t numOfRandoms>
void GlvRadiative3<TqperpGenerate, TqperpCalculate, numOfRandoms>::SetRandoms( boost::array<double, numOfRandoms>& randoms )
{
...
template<typename TqperpGenerate, typename TqperpCalculate, std::size_t numOfRandoms>
void GlvRadiative3<TqperpGenerate, TqperpCalculate, numOfRandoms>::GetAnswer( std::vector<double>& answers ) const
{
  answers[0] = GetdNdxdk();
}

template<typename TqperpGenerate, typename TqperpCalculate, std::size_t numOfRandoms>
double GlvRadiative3<TqperpGenerate, TqperpCalculate, numOfRandoms>::GetKmax() const
{
  double kmax;
  switch (_switchkmax)
  {
...
template<typename TqperpGenerate, typename TqperpCalculate, std::size_t numOfRandoms>
double GlvRadiative3<TqperpGenerate, TqperpCalculate, numOfRandoms>::Interference( long m, long zeroes ) const
{
...
template<typename TqperpGenerate, typename TqperpCalculate, std::size_t numOfRandoms>
double GlvRadiative3<TqperpGenerate, TqperpCalculate, numOfRandoms>::CdotB( long m, long zeroes ) const
{
...
template<typename TqperpGenerate, typename TqperpCalculate, std::size_t numOfRandoms>
double GlvRadiative3<TqperpGenerate, TqperpCalculate, numOfRandoms>::Summation( long mmin, long zeroes ) const
{
  double result = 0.;
...
template<typename TqperpGenerate, typename TqperpCalculate, std::size_t numOfRandoms>
double GlvRadiative3<TqperpGenerate, TqperpCalculate, numOfRandoms>::GetdNdxdk() const
{
